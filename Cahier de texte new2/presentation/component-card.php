    ...
    <section id="content-types">
        <div class="row">
            <div class="col-xl-4 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <img class="img-fluid" src="assets/images/samples/road-over-dutch-dike-PLN5XJR.jpg" alt="Card image cap">
                    </div>
            ...
            <div class="col-xl-4 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img src="assets/images/samples/inspirational-aerial-landscape-autumn-forest-and-FU2LKHA.jpg" class="card-img-top img-fluid"
                            alt="singleminded">
                        <div class="card-body">
                        ...
                        <div id="carousel-example-card" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner rounded-0" role="listbox">
                                <div class="carousel-item active">
                                    <img src="assets/images/samples/white-pelicans-pelecanus-onocrotalus-P4TFZ6E.jpg" class="d-block w-100"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/samples/lovatnet-lake-beautiful-nature-norway-PUTLQJ4.jpg" class="d-block w-100"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/samples/moody-autumn-day-in-the-dolomites-forest-and-MBFNHV2.jpg" class="d-block w-100"
                                        alt="Third slide">
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img class="card-img-top img-fluid" src="assets/images/samples/aerial-panoramic-image-of-sansonvale-lake-X6TCENW.jpg"
                            alt="Card image cap" />
                        <div class="card-body">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <img class="card-img-bottom img-fluid" src="assets/images/samples/inspirational-aerial-landscape-autumn-forest-and-FU2LKHA.jpg"
                            alt="Card image cap">
                    </div>
                </div>
            </div>
    ...
    <section id="card-caps">
        <div class="row">
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img class="card-img img-fluid" src="assets/images/samples/programmers-coding-computer-app-7CFXNL5.jpg" alt="Card image">
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img class="card-img img-fluid" src="assets/images/samples/modern-teaching-concept-P7BTJU7.jpg" alt="Card image">
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img class="card-img img-fluid" src="assets/images/samples/happy-children-building-robots-at-robotics-school-PW3NYKH.jpg" alt="Card image">
                        <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                            <div class="overlay-content">
                                <p class="card-text text-ellipsis">
                                    Sugar plum tiramisu sweet. Cake jelly marshmallow cotton candy chupa
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-content">
                        <img class="card-img img-fluid" src="assets/images/samples/learning-new-codes-8VKXG4E.jpg" alt="Card image">
                        <div class="card-img-overlay overlay-dark d-flex justify-content-between flex-column">
                            <div class="overlay-content">
        ...
        <div class="row">
                    ...
                    <div class="card-content">
                        <div class="row no-gutters">
                            <div class="col-md-12 col-lg-4">
                                <img src="assets/images/samples/banner/banner-35.jpg" alt="element 01"
                    ...
                    <div class="card-content">
                        <div class="row no-gutters">
                            <div class="col-lg-4 col-md-12 d-flex align-items-center justify-content-center p-1">
                                <img src="assets/images/samples/elements/apple-lap.png" class="card-img img-fluid"
                                    alt="apple-lap.png">
                            </div>
                    ...
                    <div class="card-content">
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-4 col-12">
                                <img src="assets/images/samples/banner/banner-30.jpg" alt="element 01"
            ...
            <div class="col-xl-4 col-sm-6 col-12">
                <div class="card text-center bg-secondary bg-lighten-1">
                    <div class="card-content text-white">
                        <div class="card-body">
                            <img src="assets/images/samples/elements/amazon-speaker.png" alt="element 05"
            ...
            <div class="col-xl-4 col-sm-6 col-12">
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <img src="assets/images/samples/elements/beats-headphones.png" alt="element 02"
                                class="mb-1">
        ...
        <div class="row match-height">
            <div class="col-12">
                <div class="card-group">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-top img-fluid" src="assets/images/samples/pages/content-img-4.jpg"
                                alt="Card image cap">
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
                                <p class="card-text">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <img class="card-img-top img-fluid" src="assets/images/samples/pages/content-img-1.jpg"
                                alt="Card image cap">
                            <div class="card-body">
                                <h4 class="card-title">Card title</h4>
                                <p class="card-text">
